<section class="twitter-block">
  ...
  <div class="twitter-block__tweet-info small-font-size">
    <a href="https://twitter.com/gauntface">@gauntface</a><?php if(isset($title)) {?><span class="twitter-block__info-spacer"> . </span><time datetime="<?php echo date("Y-m-d", $title->getTime()); ?>"><?php echo date("M d", $title->getTime()); ?></time><?php } ?>
  </div>
  <?php if(isset($title)) {?>
