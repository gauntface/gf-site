...
export default class PushController{
  ...
  sendSubscriptionToServer(subscription) {
    console.log('Subscribing with: ', subscription.endpoint);
    return fetch('/api/push/subscribe', {
      ...
      .catch((err) => {
        ...
        console.log('Error when stashing the subscription on our server', err);
        this.setState(this.STATE.UNSUBSCRIBED);
      });
  }

  removeSubscriptionFromServer(subscription) {
    console.log('Unsubscribing with: ', subscription.endpoint);
