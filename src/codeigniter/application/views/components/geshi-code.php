...
<div class="javascript syntax_highlight">&nbsp; &nbsp; <span class="kw1">function</span> compileSassAutoprefix<span class="br0">(</span>genSourceMaps<span class="br0">)</span> <span class="br0">{</span><br>
